...
urlpatterns = [
    ...
    path('UsersApp/mention_legal/', TemplateView.as_view(template_name='UsersApp/mention_legal.html'),
         name='mention_legal'),
    path('UsersApp/contact/', TemplateView.as_view(template_name='UsersApp/contact.html'), name='contact'),
