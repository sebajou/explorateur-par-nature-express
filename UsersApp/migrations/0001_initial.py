# Generated by Django 3.2.5 on 2021-07-09 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_tutor', models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.DO_NOTHING, to='UsersApp.tutor')),
            ],
            options={
                'db_table': 'tutor_link',
                'managed': True,
        ...
        migrations.AddField(
            model_name='tutor',
            name='id_tribut',
            field=models.ForeignKey(db_column='id_tribut', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Trophies',
            fields=[
        ...
        migrations.AddField(
            model_name='child',
            name='id_tribut',
            field=models.ForeignKey(db_column='id_tribut', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL),
        ),
    ]
